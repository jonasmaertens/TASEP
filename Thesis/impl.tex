    ...
    \begin{algorithmic}
        ...
        \While{$t < T$}
            ...
            \If {site $S_{x_1,x_2}\neq 0$}
                ...
                \If {site $\bm{x}+\bm{d}$ == 0 \textbf{and} $\bm{d} \neq \text{left}$ \textbf{and} random $r\in (0,1) < S_{x_1,x_2}=v_{x_1,x_2}$}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{uml_bigfont.pdf}
...
\begin{algorithm}[h]
    ...
    \begin{algorithmic}
        ...
        \State \textcolor{blue}{Initialize temporary storage $\mathcal{M}$ (Hashmap) for $(s,a,r)$ tuples with particle IDs as keys}
