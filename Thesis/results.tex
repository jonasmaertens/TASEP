...
\begin{equation}
    ...
    \end{cases}
\end{equation}
where $r$ is the distance between two particles and $\Delta v$ is the difference in speed between them. This pairwise potential is taken between the current particle and every other particle in the observation and summed up to form the reward. 
\\
\\
% Overwhelming at first, but analyze in detail, look at figure is better than equation
% first check speed diff, then check distance, this way its easy to understand
